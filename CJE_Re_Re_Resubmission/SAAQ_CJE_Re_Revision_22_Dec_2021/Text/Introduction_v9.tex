...
Comparing the results by gender, we see that both males and females change their behaviour, 
...
for males until age 55, while there appears to be no difference in the age effect for females. 
Furthermore, we find that the deterrence effect increases sharply with the balance of 
demerit points from prior offences, 
but this result is most pronounced for male drivers.
