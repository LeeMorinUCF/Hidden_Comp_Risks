...
%In contrast, we study speeding,
%which is an event further up the chain of causation that happens more frequently. 
...
% 
%\citet{meirambayeva2014} 
%analyze aggregated monthly data on traffic collisions
%and find an intervention effect for young males
%but not for females or mature males. 
...
% {\Large Revise description of our paper.}
...
% 
% What we find from this analysis is a difference by gender and use it to form
