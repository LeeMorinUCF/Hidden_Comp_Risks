...
% Maybe this is the beginning of the Empirical section:
...
% Insert statement on statistical significance, 
...
% Tables that include pooled regressions (both male and female drivers):
% \input{../Tables/seas_Logit_vs_LPMx100K_pooled_regs}
\input{../Tables/seas_Logit_vs_LPMx100K_pooled_only_regs}

\input{../Tables/seas_Logit_vs_LPMx100K_regs}

We begin by running the regression using the full sample, shown in 
Table \ref{tab:seas_Logit_vs_LPMx100K_pooled_regs}.\footnote{%
...
% 
% Shown in Table X.
% Move up to intro instead of "(see below)":
