...
#
# This version estimates the probit model to compare the estimates
# with those of the logit model.
#
################################################################################
...
cat(sprintf('%% Appendix: Comparison of Logit vs Probit\n\n'),
...
# Insert a title page.
cat('\\input{SAAQ_App_Probit_Intro}\n\n',
    file = tab_path, append = TRUE)
cat(sprintf('\n\n%s\n\n', divider),
    file = tab_path, append = TRUE)
