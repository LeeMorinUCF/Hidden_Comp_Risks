...
these results highlight (three?) main findings. 
% 
First, the pooled regressions measure the overall policy effect, 
which may be compared to other policy analyses that do not
...
[Describe difference from Ai and Norton (2003) here.]
In sum, these coefficients measure different quantities
and one would not expect them to have the same values 
or pattern of significance. 
% 
From this perspective, the marginal effects from both models, 
which measure (partial derivatives)
